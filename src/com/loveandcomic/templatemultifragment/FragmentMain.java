 ...
 */
public class FragmentMain extends AbsFragmentWithCommonVariable{

	///////////////////////////////////////////////////////////
	//フィールド
	///////////////////////////////////////////////////////////
	//継承されたフィールド
	//◆private Activity my_activity //フラグメントの持ち主となるアクティビティ
	//◆private Fragment my_fragment //フラグメント自身
	...
	public View onCreateView(
		...
		View rootView = inflater.inflate(
			R.layout.fragment_main, //レイアウトXMLのファイル名
	...
	public void onStart() {
		...
		//////////////////////////////////////////////////
		//Home画面に表示される各種イメージボタンインスタンスの作成
		//レイアウトでIDを割り振ったパーツをインスタンス化
		//HashMap「img_btns」に格納
		img_btns.put("content01", (ImageButton)this.my_activity.findViewById(R.id.button_content01));
		img_btns.put("content02", (ImageButton)this.my_activity.findViewById(R.id.button_content02));
		img_btns.put("content03", (ImageButton)this.my_activity.findViewById(R.id.button_content03));
		img_btns.put("content04", (ImageButton)this.my_activity.findViewById(R.id.button_content04));
		...
		//HashMap「bmps」に格納
		bmps.put("content01", BitmapFactory.decodeResource(resources, R.drawable.home_button_content01));
		bmps.put("content02", BitmapFactory.decodeResource(resources, R.drawable.home_button_content02));
		bmps.put("content03", BitmapFactory.decodeResource(resources, R.drawable.home_button_content03));
		bmps.put("content04", BitmapFactory.decodeResource(resources, R.drawable.home_button_content04));
		...
		for(String key : img_btns.keySet()){
			...
			//ChangeFragmentClickListenerクラスは、独立したファイルとして作ったもの。
			////第一引数：フラグメント 第二引数：入れ替える内容を表した文字列
